...
fs.writeFileSync(jobPath, jobSourceLines, 'utf8');
fs.writeFileSync(internPath, internSourceLines, 'utf8');
console.log(`Wrote ${jobPath}`);
console.log(`Wrote ${internPath}`);
